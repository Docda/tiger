...
def css_info(info):
    ...
    with open('./css.txt', 'r', encoding='utf8', errors='ignore')as f:
        html = f.read()
...
def get_ug_chinese(class_name):
    with open('./cd.html', 'r', encoding='utf8', errors='ignore')as f:
        html = f.read()
    # res = requests.get(
...
def get_kphChinese(class_name):
    with open('./kph.html', 'r', encoding='utf8', errors='ignore')as f:
        html = f.read()
    # res = requests.get(
...
def get_yxChinese(class_name):
    with open('./xy.html', 'r', encoding='utf8', errors='ignore')as f:
        html = f.read()
...
def get_open_time(class_name):
    with open('./open.html', 'r', encoding='utf8', errors='ignore')as f:
        html = f.read()
    a = re.findall('y="36">(.*?)</text>', html)[0]
